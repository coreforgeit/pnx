...
class PaymentSerializer(serializers.Serializer):
    ...
    card_pan = serializers.CharField(required=False, allow_null=True, allow_blank=True, default=None)
    card_token = serializers.CharField(required=False, allow_null=True, allow_blank=True, default=None)
    ps = serializers.CharField(required=False, allow_null=True, allow_blank=True, default=None)
